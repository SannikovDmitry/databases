...
public class ForumController {
    ...
    public DescResponse details(@RequestParam("forum") String forumShortName,
    ...
    public DescResponse listPosts(@RequestParam("forum") String forumShortName,
                                  @RequestParam(value = "related", required = false) List<String> related,
    ...
    public DescResponse listThreads(@RequestParam("forum") String forumShortName,
                                    @RequestParam(value = "related", required = false) List<String> related,
                                    @RequestParam(value = "since", required = false) String since,
                                    @RequestParam(value = "limit", required = false) String limit,
                                    @RequestParam(value = "order", required = false) String order) {
    ...
    public DescResponse listUsers(@RequestParam("forum") String forumShortName,
