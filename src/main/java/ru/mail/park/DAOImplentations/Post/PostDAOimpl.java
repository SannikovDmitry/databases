package ru.mail.park.DAOImplentations.Post;
...
public class PostDAOimpl implements PostDAO {
    ...
    public ResponseModel create(String postString) {
        final PostMainModel dataSet;
        ...
        try {
            ...
            try {
                dataSet = new PostMainModel(jsonNode);
            } catch (Exception e) {
                return new ResponseModel("INCORRECT REQUEST", ResponseModel.INCORRECT_REQUEST);
            }
        } catch (IOException e) {
        ...
        try (Connection connection = Application.connection.getConnection()) {
            ...
            return new ResponseModel(dataSet, ResponseModel.OK);
        } catch (SQLException e) {
    ...
    @Override
    public ResponseModel details(String postId, final List<String> related) {
        if (postId == null)
            return new ResponseModel("INCORRECT REQUEST", ResponseModel.INCORRECT_REQUEST);
        ...
        try (Connection connection = Application.connection.getConnection()) {
            ...
            final ResultSet resultSet = preparedStatement.executeQuery();
            final PostMainModel post;

            if (resultSet.next()) {
                post = new PostMainModel(resultSet);
            } else {
            ...
            return new ResponseModel(post, ResponseModel.OK);
        } catch (SQLException e) {
            return new ResponseModel("UNKNOWN ERROR", ResponseModel.UNKNOWN_ERROR);
        }
    }
    ...
    @Override
    public ResponseModel list(String forumShortName, String threadId, String since,
    ...
    @Override
    public ResponseModel removeOrRestore(String postString, String action) {
        final JsonNode json;
        try {
    ...
    @Override
    public ResponseModel update(String postString) {
        final JsonNode json;
        try {
            json = mapper.readValue(postString, JsonNode.class);
        } catch (IOException e) {
